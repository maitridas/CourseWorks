...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embedded_to_hidden_weight = nn.Parameter(torch.Tensor(self.n_features*self.embed_size,self.hidden_size))
        nn.init.xavier_uniform_(self.embedded_to_hidden_weight, gain=1.0)
        self.embedded_to_hidden_bias = nn.Parameter(torch.Tensor(self.hidden_size))
        nn.init.uniform_(self.embedded_to_hidden_bias)
    ...
    def forward(self, w):
        ...
        h = self.dropout( F.relu( x@self.embedded_to_hidden_weight + self.embedded_to_hidden_bias ) )
